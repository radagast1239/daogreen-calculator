...
'use strict';
  global.DG_GH_CULTIVARS = [
    ...
    { id:'lollo',       name:'Лолло Россо/Бионда', sub:'компактный',             M_max:180, k:0.32, t50:27, ca:15.8, bolt:37, multicut:true,  heatSigma:60,  heatBolt:1.9, t_opt:21, babyGreen:false },
    { id:'little-gem',  name:'Little Gem',         sub:'мини-ромэн, узкий',      M_max:160, k:0.28, t50:30, ca:11.5, bolt:42, multicut:false, heatSigma:75,  heatBolt:1.5, t_opt:21, babyGreen:false },
    ...
    { id:'frillice',    name:'Фриллис / Crispino', sub:'крупный плотный',        M_max:260, k:0.26, t50:33, ca:16.3, bolt:44, multicut:false, heatSigma:85,  heatBolt:1.4, t_opt:23, babyGreen:false },
    { id:'salanova',    name:'Саланова',           sub:'многолистный',           M_max:200, k:0.32, t50:28, ca:16.9, bolt:38, multicut:true,  heatSigma:65,  heatBolt:1.7, t_opt:21, babyGreen:false },
    { id:'aficion',     name:'Афицион',            sub:'батавия RZ, жаростойкая', M_max:230, k:0.28, t50:32, ca:16.3, bolt:46, multicut:false, heatSigma:140, heatBolt:0.8, t_opt:25, babyGreen:false },
    { id:'afilion',     name:'Афилион',            sub:'батавия RZ',              M_max:210, k:0.28, t50:32, ca:16.3, bolt:45, multicut:false, heatSigma:130, heatBolt:0.9, t_opt:25, babyGreen:false },
    { id:'starfighter', name:'Старфайтер',         sub:'батавия RZ, пузырчатая',  M_max:250, k:0.26, t50:34, ca:15.8, bolt:47, multicut:false, heatSigma:150, heatBolt:0.7, t_opt:25, babyGreen:false },
    { id:'grazion',     name:'Грейзион',           sub:'батавия RZ, тяжёлая',     M_max:290, k:0.30, t50:31, ca:16.9, bolt:46, multicut:false, heatSigma:140, heatBolt:0.8, t_opt:25, babyGreen:false },
