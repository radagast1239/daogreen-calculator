...
(function(global){
  ...
  var STR = {
    ru: {
      ...
      'btn.stats': 'Статистика', 'btn.stats.title': 'Статистика по сохранённым проектам',
      ...
      'econ.payrollTax': 'Отчисления с ФОТ (работодатель)',
      'econ.payrollTaxPct': 'Ставка отчислений, %',
      'econ.payrollTaxPct.hint': 'Налоги и взносы работодателя на начисленную зарплату',
      'econ.payrollStaffCostPct': 'Налог и расходы на сотрудника, %',
      'econ.payrollStaffCostPct.hint': 'Доп. расходы от ФОТ: удержания, компенсации, прочие выплаты сотрудникам (% от начисленной зарплаты)',
      'econ.off': 'выкл.',
      ...
      'econ.cult.search': 'Поиск культуры',
      'econ.cult.searchPh': 'Начните вводить название',
      'econ.cult.yieldMode': 'Как задаём урожай',
      'econ.cult.yieldModeSqmMonth': 'Урожай с м² в месяц, кг',
      'econ.cult.yieldModeCutsMonth': 'За срезку + сборов в месяц',
      ...
      'sum.salesBerries': 'Выпуск · ягоды',
      'sum.salesVegetables': 'Выпуск · овощи',
    ...
    en: {
      ...
      'btn.stats': 'Stats', 'btn.stats.title': 'Statistics for saved projects',
      ...
      'econ.payrollTax': 'Employer payroll taxes',
      'econ.payrollTaxPct': 'Employer tax rate, %',
      'econ.payrollTaxPct.hint': 'Employer taxes and contributions on gross payroll',
      'econ.payrollStaffCostPct': 'Employee tax & costs, %',
      'econ.payrollStaffCostPct.hint': 'Extra payroll costs: withholdings, benefits, other employee-related expenses (% of gross)',
      'econ.off': 'off',
      ...
      'econ.waterPriceM3': 'Water',
      'econ.waterPriceM3.hint': 'Cost per m³ (supply, RO, settling)',
      'econ.waterFertPerM3': 'Nutrients',
      ...
      'econ.cult.search': 'Crop search',
      'econ.cult.searchPh': 'Start typing crop name',
      'econ.cult.yieldMode': 'Yield input mode',
      'econ.cult.yieldModeSqmMonth': 'Yield per m² per month, kg',
      'econ.cult.yieldModeCutsMonth': 'Per cut + cuts per month',
      ...
      'sum.salesBerries': 'Output · berries',
      'sum.salesVegetables': 'Output · vegetables',
