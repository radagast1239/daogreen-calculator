...
(function(global){
  ...
  var STR = {
    ru: {
      ...
      'btn.pdfClient': 'PDF для клиента', 'btn.pdfClient.title': 'Брендовый PDF: титул и итог экономики',
    ...
    en: {
      ...
      'btn.pdfClient': 'Client PDF', 'btn.pdfClient.title': 'Branded PDF: cover and economics summary',
