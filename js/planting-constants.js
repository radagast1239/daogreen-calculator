...
(function (global) {
  ...
  global.DG_COLLAPSE_DEFAULTS = {
    ...
    'block-mass': false,
    'block-stage': false,
    'block-panel-geom': false,
    'panel-metrics': false,
    'panel-schema': false,
    'panel-bio-margin': true,
    'panel-gh-yield-totals': true,
    'panel-planting-advanced': true,
  ...
  /** Микрозелень и беби (растущая): лотки, без рассады и шапки */
  var TRAY_LOT_CROP_IDS = ['pl-microgreens', 'pl-baby-living'];
  var TRAY_LOT_PER_PALLET = 33;
  ...
  global.DG_TRAY_LOT_PER_PALLET = TRAY_LOT_PER_PALLET;
