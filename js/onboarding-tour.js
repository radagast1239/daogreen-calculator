...
(function(global){
  ...
  var STEPS = [
    ...
    { title: 'Вкладки', body: 'Три раздела: «Посадка · каналы», «Поддоны 130×65» и «Экономика». У поддонов свой список культур и снимок настроек — выберите сорт одним нажатием на вкладке поддонов.', target: '#app-tabs' },
