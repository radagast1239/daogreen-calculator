...
(function(global){
  ...
  var STEPS = [
    ...
    { title: 'Вкладки', body: 'Три раздела: «Посадка · каналы», «Поддоны 130×65» и «Экономика». Переключайте здесь — данные сохраняются в одном проекте.', target: '#app-tabs' },
    ...
    { title: 'Сорт', body: 'Выберите культуру. Можно добавить свой сорт — параметры копируются с текущего. Для VF — секции беби / салаты / цветы.', target: '#panel-cultivars' },
    ...
    { title: 'Экономика — шаблоны', body: 'Шаблоны 150 м² / VF 300 / теплица 500 — быстрый старт. Дальше правьте культуры, доли %, цены.', target: '#econ-preset-bar' },
    { title: 'Культуры и доли', body: 'До 6 культур. Сумма долей ≤ 100%. У каждой — цена, урожай за срезку, свет (кВт·ч/м²·ч).', target: '#econ-panel-cultures' },
    ...
    { title: 'Только просмотр', body: '«Просмотр» блокирует правки — удобно показать инвестору. Снова нажмите, чтобы редактировать.', target: '#btn-readonly' },
