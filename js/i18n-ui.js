...
(function(global){
  ...
  var UIL = {
    ru: {
      ...
      'ui.pal.sysHintTrayLot': 'Лотки на стеллаже <strong>130×65 см</strong>. Плотность фиксирована: <strong>{density} лотков/м²</strong> (без кассет и крышек).',
      'ui.pal.formulaTrayLot': '{density} л/м² × площадь поддона',
      'ui.pal.prefixTray': 'На поддон:',
      'ui.pal.traysSuffix': 'лотков',
      'ui.grow.flowTrayLot': '<strong>Прорастание</strong>, затем <strong>дни до готовности/сбора</strong>. Без стадии рассады. Лотки: <strong>45 шт/м²</strong>.',
      'ui.grow.trayHarvestDays': 'Дней до готовности/сбора',
      'ui.grow.channelDays': 'Дней роста до среза/готовности',
      'ui.veg.trayLotTotal': 'проращ. {germ} + до сбора {day} = {sum} {dUnit}',
    ...
    en: {
      ...
      'ui.pal.sysHintTrayLot': 'Trays on <strong>130×65 cm</strong> rack. Fixed density: <strong>{density} trays/m²</strong> (no cassettes or lids).',
      'ui.pal.formulaTrayLot': '{density} tr/m² × pallet area',
      'ui.pal.prefixTray': 'Per pallet:',
      'ui.pal.traysSuffix': 'trays',
      'ui.grow.flowTrayLot': '<strong>Germination</strong>, then <strong>days to harvest</strong>. No nursery stage. Trays: <strong>45 pcs/m²</strong>.',
      'ui.grow.trayHarvestDays': 'Days to harvest',
      'ui.grow.channelDays': 'Days to cut/harvest',
      'ui.veg.trayLotTotal': 'germ. {germ} + to harvest {day} = {sum} {dUnit}',
