...
(function(global){
  ...
  var UIL = {
    ru: {
      ...
      'ui.planting.zone.culture': 'Культура',
      'ui.planting.zone.env': 'Климат и свет',
      'ui.planting.zone.cycle': 'Цикл и система',
      'ui.planting.zone.results': 'Результаты расчёта',
      'ui.planting.zone.more': 'Уточнения',
      ...
      'ui.env.shadePill': 'сетка −{pct}% DLI',
    ...
    en: {
      ...
      'ui.planting.zone.culture': 'Cultivar',
      'ui.planting.zone.env': 'Climate & light',
      'ui.planting.zone.cycle': 'Cycle & system',
      'ui.planting.zone.results': 'Calculation results',
      'ui.planting.zone.more': 'Refinements',
      ...
      'ui.env.shadePill': 'shade cloth −{pct}% DLI',
      'ui.env.dayPill': '{day} {val} {mol}',
