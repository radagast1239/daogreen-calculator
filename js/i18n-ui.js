...
(function(global){
  ...
  function applyUiI18n(){
    ...
    if (pdfDlg){
      ...
      ['#pdf-preset-planting', '#pdf-preset-econ', '#pdf-preset-client', '#pdf-preset-full', '#pdf-select-all', '#pdf-select-none'].forEach(function(sel, i){
        var el = document.querySelector(sel);
        var keys = ['pdf.preset.planting', 'pdf.preset.econ', 'pdf.preset.client', 'pdf.preset.full', 'pdf.select.all', 'pdf.select.none'];
